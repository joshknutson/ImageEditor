...
ImageEditor.processImage = function(args){
	...
	request.open("POST", "processImage.cfm?_cf_nodebug=true", true);
...
ImageEditor.loadImage = function(){
	ImageEditor.loaderImage.setAttribute("src", "getImage.cfm?imageName=" + ImageEditor.imageName + "&t=" + (new Date).getTime());
};
